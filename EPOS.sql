...
CREATE TABLE `setmeal_dish` (
  ...
  `setmeal_id` varchar(32) COLLATE utf8_bin NOT NULL COMMENT 'setmeal_id ',
  `dish_id` varchar(32) COLLATE utf8_bin NOT NULL COMMENT 'dish_id',
  ...
  `create_user` bigint(20) NOT NULL COMMENT 'create_user',
  `update_user` bigint(20) NOT NULL COMMENT 'update_user',
  `is_deleted` int(11) NOT NULL DEFAULT '0' COMMENT 'is_deleted',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='relationship';
 
-- ----------------------------
-- Records of setmeal_dish
-- ----------------------------
INSERT INTO `setmeal_dish` VALUES ('1415580119052894209', '1415580119015145474', '1397862198033297410', 'soup', '49800.00', '1', '0', '2021-07-15 15:52:55', '2021-07-15 15:52:55', '1415576781934608386', '1415576781934608386', '0');
INSERT INTO `setmeal_dish` VALUES ('1415580119061282817', '1415580119015145474', '1413342036832100354', 'bear', '500.00', '1', '0', '2021-07-15 15:52:55', '2021-07-15 15:52:55', '1415576781934608386', '1415576781934608386', '0');
